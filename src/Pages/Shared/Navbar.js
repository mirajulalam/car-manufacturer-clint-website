...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 sticky top-0 z-50 max-w-7xl mx-auto px-12">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-2xl text-primary font-bold ">Car Parts Manufacturer</a>
            </div>
